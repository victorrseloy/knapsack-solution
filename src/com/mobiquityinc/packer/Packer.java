...
//		System.out.println(solvePackerInstance(new PackerInstance("81 : (1,53.38,€45) (2,88.62,€98) (3,78.48,€3) (4,72.30,€76) (5,30.18,€9)\n" + 
//				"(6,46.34,€48)")));
//		
//		System.out.println(solvePackerInstance(new PackerInstance("8 : (1,15.3,€34)")));
//		
//		System.out.println(solvePackerInstance(new PackerInstance("75 : (1,85.31,€29) (2,14.55,€74) (3,3.98,€16) (4,26.24,€55) (5,63.69,€52)\n" + 
//				"(6,76.25,€75) (7,60.02,€74) (8,93.18,€35) (9,89.95,€78)")));
//		
//		System.out.println(solvePackerInstance(new PackerInstance("56 : (1,90.72,€13) (2,33.80,€40) (3,43.15,€10) (4,37.97,€16) (5,46.81,€36)\n" + 
//				"(6,48.77,€79) (7,81.80,€45) (8,19.36,€79) (9,6.76,€64)")));
		
		System.out.println(pack("./test.txt"));
	 ...
	 * of this function is O(N) where N is the quantity of possible items to be included in the bag and O(N) < O(M*N) ∀ N > 0
